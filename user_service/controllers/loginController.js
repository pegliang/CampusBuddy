...
async function loginController(req, res) {
    ...
    try {
        ...
        const accessToken = jwt.sign(payload, process.env.JWT_SECRET_ACCESS_TOKEN_KEY, { expiresIn: "30m" });
        const refreshToken = jwt.sign(payload, process.env.JWT_SECRET_REFRESH_TOKEN_KEY, { expiresIn: "60m" });
